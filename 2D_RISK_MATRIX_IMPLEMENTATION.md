...
**Results**:
- **With gates**: 87.5% pass rate ✅
- **Without gates**: 56.2% pass rate ❌
...
|----------|-------------|------------|---------|------------|
| **Franchise Cornerstone** | High (≥70%) | Low (<30%) | Luka, Jokić | Max contract, build around |
| **Luxury Component** | High (≥70%) | High (≥70%) | Poole, Sabonis | Valuable in system, risky as #1 |
| **Depth** | Low (<30%) | Low (<30%) | Role players | Reliable but limited |
| **Avoid** | Low (<30%) | High (≥70%) | System merchants | Empty calories |

### The "Morey Pitch"

**Luka**: High Performance / Low Dependence = **Franchise Cornerstone** → Max contract, build around  
**Poole**: High Performance / High Dependence = **Luxury Component** → Valuable in system, **DO NOT MAX**
...
**Risk Categorization**:
- **Franchise Cornerstone**: Performance ≥70% AND Dependence <30%
- **Luxury Component**: Performance ≥70% AND Dependence ≥70%
- **Depth**: Performance <30% AND Dependence <30%
- **Avoid**: Performance <30% AND Dependence ≥70%
...
1. **Jordan Poole (2021-22)**:
   ...
   - Validation: All three should be high → High Dependence Score

2. **Luka Dončić (2023-24)**:
   - Expected: High Performance + Low Dependence (portable)
   - Check: Low assisted%, low open shot%, high self-creation
   - Validation: All three should be low → Low Dependence Score
...
- **Engineering**: Building a model that predicts outcomes (✅ Done)
- **Science**: Understanding when outcomes reflect talent vs. context (🎯 In Progress)
...
- **Luka**: "Franchise Cornerstone" → Max contract, build around
- **Poole**: "Luxury Component" → Valuable in system, risky as #1
- This acknowledges reality (Poole was good) while capturing nuance (Poole is risky)

...
def calculate_helio_index_test():
    ...
    # Check Jokic Rank
    if "Nikola Jokic" in peak_seasons['PLAYER_NAME'].values:
        jokic_data = peak_seasons[peak_seasons['PLAYER_NAME'] == "Nikola Jokic"].iloc[0]
        jokic_rank = peak_seasons.index[peak_seasons['PLAYER_NAME'] == "Nikola Jokic"][0]
